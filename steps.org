...
#+caption: Peason correlation coefficient for decoherence time of $t_1 = 3000$
#+NAME: tab:pearson_corr_3000
#+ATTR_LATEX: :booktabs :environment :font \tiny :width \textwidth :float t
#+TBLNAME: 
...
#+caption: Peason correlation coefficient for decoherence time of $t_1 = 1000$
#+NAME: tab:pearson_corr_3000
#+ATTR_LATEX: :booktabs :environment :font \tiny :width \textwidth :float t
#+TBLNAME: 
|                 | # of Gates | # of SWAPs |   Depth |   $V_Q$ |
