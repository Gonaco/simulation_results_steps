...
\section{First Step}
\label{sec:org464d4a7}

\begin{table}[htbp]
\caption{\label{tab:orgb0e0f27}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:orgb0c8cb6}

\subsubsection{No initial placement}
\label{sec:orgbfe980f}
...
\label{sec:orgd809a29}

\begin{table}[htbp]
\caption{\label{tab:org5a8ac6b}
...
\label{sec:org36d6506}

\begin{table}[htbp]
\caption{\label{tab:org3bfded4}
