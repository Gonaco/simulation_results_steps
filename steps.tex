...
\label{sec:orgb8c068d}

\begin{table}[!htpb]
\caption{\label{tab:org0b54b3d}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org498e9b8}

\begin{table}[H]
\caption{\label{tab:org07f6263}
...
\label{sec:orgf4e8c49}

\begin{table}[H]
\caption{\label{tab:org417a2f5}
...
\label{sec:orgdce7ae9}

\begin{table}[H]
\caption{\label{tab:orgf383831}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9554be5}
\begin{table}[H]
\caption{\label{tab:org14b4ebf}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd90f0e3}
\begin{table}[H]
\caption{\label{tab:org56e83b0}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5e59462}

\begin{table}[H]
\caption{\label{tab:orga93aace}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org0fd48bc}
\begin{table}[H]
\caption{\label{tab:org176eec3}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org1e65105}
\begin{table}[H]
\caption{\label{tab:orgfb245be}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2e02403}
\begin{table}[H]
\caption{\label{tab:orgb15d8b3}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1c32226}
\begin{table}[H]
\caption{\label{tab:org4a79efa}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8d7734b}
\begin{table}[H]
\caption{\label{tab:org2d3ce9f}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgce229b9}
\begin{table}[H]
\caption{\label{tab:org639656f}
...
\label{sec:org6a1243e}
\begin{table}[H]
\caption{\label{tab:org8cd8919}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org41c747a}
\begin{table}[H]
\caption{\label{tab:org760097c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org26f1ff6}
\begin{table}[H]
\caption{\label{tab:org738e05c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2a73418}
\begin{table}[H]
\caption{\label{tab:orge862413}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgac6f877}
\begin{table}[H]
\caption{\label{tab:org92e22dd}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8f42e5d}
\begin{table}[H]
\caption{\label{tab:org55ae46f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgbc7f4de}
\begin{table}[H]
\caption{\label{tab:org06d2b23}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org155b011}
\begin{table}[H]
\caption{\label{tab:org4a01f0f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org49136ff}
\begin{table}[H]
\caption{\label{tab:orgd62b161}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgb3152fd}
\begin{table}[H]
\caption{\label{tab:org9b93b55}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5c06cc8}

\subsection{\(t_1=3000\)}
\label{sec:org642abe1}

\begin{table}[htbp]
\caption{\label{tab:org2472471}
Peason correlation coefficient for decoherence time of \(t_1 = 3000\)}
\centering
\tiny
\begin{tabular}{lrrrr}
...
\subsection{\(t_1=1000\)}
\label{sec:org1ffa0d1}

\begin{table}[htbp]
\caption{\label{tab:org09f294e}
