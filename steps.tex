...
\label{sec:org94211dc}

\begin{table}[!htpb]
\caption{\label{tab:orgdd333cb}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org423f60b}

\begin{table}[H]
\caption{\label{tab:org6beb87c}
...
\label{sec:orgee64f97}

\begin{table}[H]
\caption{\label{tab:org0de1ac9}
...
\label{sec:orgd5f51d8}

\begin{table}[H]
\caption{\label{tab:org560923f}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org46a0a7c}
\begin{table}[H]
\caption{\label{tab:orga5bf261}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7918663}
\begin{table}[H]
\caption{\label{tab:orgc171bfa}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org74f69af}

\begin{table}[H]
\caption{\label{tab:org1ce7c15}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga169b2a}
\begin{table}[H]
\caption{\label{tab:org2a94d13}
Results after 1000 iterations}
\centering
\small
...
\label{sec:orgcff9434}
\begin{table}[H]
\caption{\label{tab:org2e5236f}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgbfb24b8}
\begin{table}[H]
\caption{\label{tab:orga48d548}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8078f49}
\begin{table}[H]
\caption{\label{tab:org26517eb}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7a658e7}
\begin{table}[H]
\caption{\label{tab:orgad0232e}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1c15d67}
\begin{table}[H]
\caption{\label{tab:orge0c31b5}
...
\label{sec:org6aabd3b}
\begin{table}[H]
\caption{\label{tab:org5fa2a35}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf32b91b}
\begin{table}[H]
\caption{\label{tab:orgcab146a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orge050c43}
\begin{table}[H]
\caption{\label{tab:orgbb74ab3}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org73352b7}
\begin{table}[H]
\caption{\label{tab:org35a53f4}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7561a2b}
\begin{table}[H]
\caption{\label{tab:org814a72e}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org52d0f11}
\begin{table}[H]
\caption{\label{tab:org56bda17}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org88c115e}
\begin{table}[H]
\caption{\label{tab:org7123449}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc25e33e}
\begin{table}[H]
\caption{\label{tab:org7a5bb24}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd40e7d2}
\begin{table}[H]
\caption{\label{tab:orgf827f24}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgff4dd6d}
\begin{table}[H]
\caption{\label{tab:org2e65064}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org383c328}

\begin{center}
\captionof{table}{\label{tab:org674c975}
Pearson correlation coefficient for decoherence time of \(t_1 = 3000\)}
\begin{tabular}{lrrrr}
...
\caption{\label{fig:org9dd4ed9}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:orgd4f8a7c}

\begin{center}
\captionof{table}{\label{tab:org9dd19db}
Pearson correlation coefficient for decoherence time of \(t_1 = 1000\)}
\begin{tabular}{lrrrr}
 & \# of Gates & \# of SWAPs & Depth & \(V_Q\)\\
\hline
