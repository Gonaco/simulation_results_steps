...
\label{sec:org180fba1}

\begin{table}[!htpb]
\caption{\label{tab:orgab594e3}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:orgb513281}

\begin{table}[H]
\caption{\label{tab:orgf51fa89}
...
\label{sec:orgbf71005}

\begin{table}[H]
\caption{\label{tab:org32bf541}
...
\label{sec:org5dc4250}

\begin{table}[H]
\caption{\label{tab:org654ed4a}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org331e365}
\begin{table}[H]
\caption{\label{tab:org880a980}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5af3fde}
\begin{table}[H]
\caption{\label{tab:orgcb4a4ad}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgb9852b9}

\begin{table}[H]
\caption{\label{tab:org2a35bc2}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgbdb8a37}
\begin{table}[H]
\caption{\label{tab:orgae434bf}
Results after 1000 iterations}
\centering
\small
...
\label{sec:orgaac3701}
\begin{table}[H]
\caption{\label{tab:org7afb20b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org686a069}
\begin{table}[H]
\caption{\label{tab:orgca30e3d}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7455276}
\begin{table}[H]
\caption{\label{tab:orgc76bb1c}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgdfb9953}
\begin{table}[H]
\caption{\label{tab:org7fffa66}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org47172e8}
\begin{table}[H]
\caption{\label{tab:orgdf03def}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgee5f13e}
\begin{table}[H]
\caption{\label{tab:org4dc5ae5}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org4559415}
\begin{table}[H]
\caption{\label{tab:org32bd5b2}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7108efe}
\begin{table}[H]
\caption{\label{tab:orgd5bea40}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgb9860f4}
\begin{table}[H]
\caption{\label{tab:orgcb03f8a}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org5d754b3}
\begin{table}[H]
\caption{\label{tab:org59aaed6}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9a1b8e0}
\begin{table}[H]
\caption{\label{tab:orgae853e2}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org66b14da}
\begin{table}[H]
\caption{\label{tab:orgc156f71}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
