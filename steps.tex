...
\label{sec:org051ad44}

\begin{table}[!htpb]
\caption{\label{tab:orgc76376f}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:orgef59b4f}

\begin{table}[H]
\caption{\label{tab:orgbfe77d8}
...
\label{sec:orgc30e786}

\begin{table}[H]
\caption{\label{tab:org8991930}
...
\label{sec:org325e5f7}

\begin{table}[H]
\caption{\label{tab:org310ca39}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org0b82561}
\begin{table}[H]
\caption{\label{tab:orgf4b5d26}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgb832836}
\begin{table}[H]
\caption{\label{tab:orga499525}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8d69e4a}

\begin{table}[H]
\caption{\label{tab:orgb160a5d}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf498513}
\begin{table}[H]
\caption{\label{tab:org77e3c49}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org68a9fcd}
\begin{table}[H]
\caption{\label{tab:orgdd04bfe}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgfab97bb}
\begin{table}[H]
\caption{\label{tab:org9b93ea0}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org95b6b73}
\begin{table}[H]
\caption{\label{tab:orgcd53a3f}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2d8883b}
\begin{table}[H]
\caption{\label{tab:orgbdd369c}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9f21425}
\begin{table}[H]
\caption{\label{tab:org872f9f3}
...
\label{sec:org9ed798f}
\begin{table}[H]
\caption{\label{tab:org6a81eab}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6eacec6}
\begin{table}[H]
\caption{\label{tab:org0345dfc}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org0bd907a}
\begin{table}[H]
\caption{\label{tab:org015fd9b}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org0c20369}
\begin{table}[H]
\caption{\label{tab:orgb1ec5ca}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org96cbde7}
\begin{table}[H]
\caption{\label{tab:orgaa5ce0c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org4c1c5a1}
\begin{table}[H]
\caption{\label{tab:orgf0348ea}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org2da21bf}
\begin{table}[H]
\caption{\label{tab:orgec46d16}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2ad0224}
\begin{table}[H]
\caption{\label{tab:org0bc62d1}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org0ee8f2c}
\begin{table}[H]
\caption{\label{tab:orgec83a36}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2dbc242}
\begin{table}[H]
\caption{\label{tab:orgfba55eb}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org2ce1dbd}

\begin{center}
\captionof{table}{\label{tab:org490d304}
...
\subsection{\(t_1=1000\)}
\label{sec:org8ad1caf}

\begin{center}
\captionof{table}{\label{tab:orgd22a46a}
...
\label{sec:org16b802b}

\begin{center}
\captionof{table}{\label{tab:org86737cf}
