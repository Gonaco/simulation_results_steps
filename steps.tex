...
\label{sec:org1d89cd4}

\begin{table}[!htpb]
\caption{\label{tab:orga4e2190}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org99c7ce6}

\begin{table}[H]
\caption{\label{tab:orgf938a9c}
...
\label{sec:org42d51ca}

\begin{table}[H]
\caption{\label{tab:org1c664d4}
...
\label{sec:orgb61fce7}

\begin{table}[H]
\caption{\label{tab:org918fd78}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6cb5072}
\begin{table}[H]
\caption{\label{tab:org8153d96}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf505bb7}
\begin{table}[H]
\caption{\label{tab:org69ac567}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org4aad4f7}

\begin{table}[H]
\caption{\label{tab:org0b6fce4}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org4aa18ad}
\begin{table}[H]
\caption{\label{tab:org53036ff}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org033b08b}
\begin{table}[H]
\caption{\label{tab:org4443ab4}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org802ebfe}
\begin{table}[H]
\caption{\label{tab:org4d84b63}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org94b2bca}
\begin{table}[H]
\caption{\label{tab:org305cb11}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org58d2b3d}
\begin{table}[H]
\caption{\label{tab:org7803f03}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org4cf1689}
\begin{table}[H]
\caption{\label{tab:org89a18ad}
...
\label{sec:orgadba29d}
\begin{table}[H]
\caption{\label{tab:org5ee35b3}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7e1b5d5}
\begin{table}[H]
\caption{\label{tab:org933acba}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgf9d45e7}
\begin{table}[H]
\caption{\label{tab:org6e79226}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org200ec09}
\begin{table}[H]
\caption{\label{tab:orga0bd338}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9ceefbb}
\begin{table}[H]
\caption{\label{tab:orgd19db85}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2580500}
\begin{table}[H]
\caption{\label{tab:orge04f184}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org429b683}
\begin{table}[H]
\caption{\label{tab:orga232064}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org05e0d9f}
\begin{table}[H]
\caption{\label{tab:org18bb40c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org849f480}
\begin{table}[H]
\caption{\label{tab:orgc91fc38}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga987144}
\begin{table}[H]
\caption{\label{tab:org218bbbe}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org1b2d828}

\begin{center}
\captionof{table}{\label{tab:orgb463d85}
...
\label{sec:org6b4eb65}

\begin{enumerate}
\item Number of two qubit gates
\label{sec:org018eeea}
...
\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{f_2qg_3000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:f_2qg_3000_0_005}
\vspace{4ex}
\end{subfigure}

\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{ps_2qg_3000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:ps_2qg_3000_0_005}
\end{subfigure}

\label{fig:2qg_3000_0_005}
\caption{Two-qubit gates analysis }
\end{figure}

\item Difference and number of SWAPs
\label{sec:org681b314}

$$\rho _{f',\text{# 2qg}} = 0.5784$$

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{f_s_2qg_3000_0_005.png}
\caption{\label{fig:org2a814ee}
Number of swaps and fidelity difference relationship's}
\end{figure}

\item Proportion of SWAPs
\label{sec:orge79a13c}
...
\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{f_sprop_3000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:f_2qg_3000_0_005}
\vspace{4ex}
\end{subfigure}
...
\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{ps_sprop_3000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:ps_2qg_3000_0_005}
\end{subfigure}

\label{fig:2qg_3000_0_005}
\caption{Proportion of SWAPs analysis}
\end{figure}
\end{enumerate}

\subsection{\(t_1=1000\)}
\label{sec:org4ce211d}

\begin{center}
\captionof{table}{\label{tab:org15a97ee}
...
\subsubsection{Two-qubit gates}
\label{sec:org646a1cd}

\begin{enumerate}
\item Number of two qubit gates
\label{sec:org1f11920}
...
\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{f_2qg_1000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:f_2qg_3000_0_005}
    \vspace{4ex}
\end{subfigure}
...
\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{ps_2qg_1000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:ps_2qg_3000_0_005}
\end{subfigure}
...
\item Difference and number of SWAPs
\label{sec:orgb7bcdee}

$$\rho _{f',Y} = -0.639791579133524$$

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{f_s_2qg_1000_0_005.png}
\caption{\label{fig:org633164f}
Number of swaps and fidelity difference relationship's}
\end{figure}


\item Proportion of SWAPs
\label{sec:org8c6325a}
...
\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{f_sprop_1000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:f_sprop_1000_0_005}
\vspace{4ex}
\end{subfigure}

\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{ps_sprop_1000_0_005}
\caption{Number of two-qubit gates against fidelity}
\label{fig:ps_sprop_1000_0_005}
\end{subfigure}

\label{fig:sprop_1000_0_005}
\caption{Proportion of SWAPs analysis}
\end{figure}
\end{enumerate}
...
\label{sec:org95bf9f3}

\begin{center}
\captionof{table}{\label{tab:org1195f08}
...
\label{sec:org7771a6b}

\begin{enumerate}
\item Number of two qubit gates
\label{sec:org1b35249}
...
\centering
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{f_2qg_3000_0}
    \caption{Number of two-qubit gates against fidelity} 
    \label{fig:f_2qg_3000_0}
    \vspace{4ex}
  \end{subfigure}%% 

\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{ps_2qg_3000_0}
\caption{Number of two-qubit gates against fidelity}
\label{fig:ps_2qg_3000_0}
\end{subfigure}

\label{fig:2qg_3000_0}
\caption{Two-qubit gates analysis }
\end{figure}

\item Difference and number of SWAPs
\label{sec:org84d3d0f}

$$\rho _{f',Y} = 0.4445$$

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{f_s_2qg_3000_0.png}
\caption{\label{fig:org3d19ea6}
Number of swaps and fidelity difference relationship's}
\end{figure}

\item Proportion of SWAPs
\label{sec:orga8f4925}
...
\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{f_sprop_3000_0}
\caption{Number of two-qubit gates against fidelity}
\label{fig:f_sprop_3000_0}
\vspace{4ex}
\end{subfigure}

\begin{subfigure}[b]{0.5\linewidth}
\centering
\includegraphics[width=0.75\linewidth]{ps_sprop_3000_0}
\caption{Number of two-qubit gates against fidelity}
\label{fig:ps_sprop_3000_0}
\end{subfigure}

\label{fig:sprop_3000_0}
\caption{Proportion of SWAPs analysis}
\end{figure}
\end{enumerate}
\end{document}
