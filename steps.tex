...
\section{First Step}
\label{sec:orgf817f9c}

\begin{table}[htbp]
\caption{\label{tab:org1a2efd5}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:orgec578ae}

\subsubsection{No initial placement}
\label{sec:orge0c8245}
...
\label{sec:org37abfcd}

\begin{table}[htbp]
\caption{\label{tab:org12a0174}
...
\label{sec:orgca12117}

\begin{table}[htbp]
\caption{\label{tab:org7b573bc}
