...
\section{First Step}
\label{sec:org5219626}

\begin{table}[htbp]
\caption{\label{tab:org05e25c0}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:orgbb2c7c3}

\subsubsection{No initial placement}
\label{sec:org5d94941}

\begin{minipage}[t]{.45\textwidth}

\begin{enumerate}
\item With Resource constraints
\label{sec:org84ea619}
...
\item Without Resource constraints
\label{sec:org4c177e4}
...
\label{sec:orga42acc5}

\begin{minipage}[t]{.45\textwidth}

\begin{enumerate}
\item With Resource constraints
\label{sec:org499b25b}
...
\label{sec:org80cc328}
\section{Simplest benchmarks results}
\label{sec:org6be4e43}
\end{document}
