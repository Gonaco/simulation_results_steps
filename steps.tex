...
\label{sec:org302552c}

\begin{table}[!htpb]
\caption{\label{tab:orgb2b5ebf}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org7553859}

\begin{table}[H]
\caption{\label{tab:org8ab4cdb}
...
\label{sec:org64b7501}

\begin{table}[H]
\caption{\label{tab:orgfcf871f}
...
\label{sec:org077a6e9}

\begin{table}[H]
\caption{\label{tab:orgb65220f}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgda0a6ab}
\begin{table}[H]
\caption{\label{tab:org93c4a60}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc08612d}
\begin{table}[H]
\caption{\label{tab:org98cc0d4}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8590fb7}

\begin{table}[H]
\caption{\label{tab:orgedc1a5b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1a64765}
\begin{table}[H]
\caption{\label{tab:org473ba87}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org94d4c02}
\begin{table}[H]
\caption{\label{tab:orga4e1bfd}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org34d51b6}
\begin{table}[H]
\caption{\label{tab:org26ae967}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org91798ea}
\begin{table}[H]
\caption{\label{tab:org341102f}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org57c9415}
\begin{table}[H]
\caption{\label{tab:org6028baa}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgec001b9}
\begin{table}[H]
\caption{\label{tab:org7b77fa2}
...
\label{sec:org7e91b5c}
\begin{table}[H]
\caption{\label{tab:org5272987}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf6d4012}
\begin{table}[H]
\caption{\label{tab:org953633f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org59210c3}
\begin{table}[H]
\caption{\label{tab:org54eb51e}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org24083a8}
\begin{table}[H]
\caption{\label{tab:org19e4943}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2a1b188}
\begin{table}[H]
\caption{\label{tab:orgeb8fe76}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org065682e}
\begin{table}[H]
\caption{\label{tab:orgd35fe6d}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org910b730}
\begin{table}[H]
\caption{\label{tab:org5776cde}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org560fbba}
\begin{table}[H]
\caption{\label{tab:org8e90e96}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga6c8095}
\begin{table}[H]
\caption{\label{tab:org5cd9dda}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org224f06e}
\begin{table}[H]
\caption{\label{tab:org099d563}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc84e55c}

\subsection{\(t_1=3000\)}
\label{sec:org3f6ae4d}

\begin{center}
\captionof{table}{\label{tab:orgb8e5d29}
...
\caption{\label{fig:orgad0175f}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:org11d610e}

\begin{center}
\captionof{table}{\label{tab:org338f49b}
