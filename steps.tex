...
\section{First Step}
\label{sec:org606daf0}

\begin{table}[htbp]
\caption{\label{tab:orgc234f24}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:orgc791095}

\subsubsection{No initial placement}
\label{sec:org9e1115f}
...
\label{sec:org063ffa4}

\begin{table}[htbp]
\caption{\label{tab:org9347aac}
...
\label{sec:orgdfc9d23}

\begin{table}[htbp]
\caption{\label{tab:org4415bb9}
