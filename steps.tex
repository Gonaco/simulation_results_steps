...
\label{sec:orgc739ce6}

\begin{table}[!htpb]
\caption{\label{tab:orgb44f02b}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org819c3d2}

\begin{table}[H]
\caption{\label{tab:org3bda286}
...
\label{sec:org843d9a0}

\begin{table}[H]
\caption{\label{tab:org385eba3}
...
\label{sec:org53935dd}

\begin{table}[H]
\caption{\label{tab:orge6c244b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org277c574}
\begin{table}[H]
\caption{\label{tab:org5193ff1}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org568c955}
\begin{table}[H]
\caption{\label{tab:org54b40ff}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org11a013e}

\begin{table}[H]
\caption{\label{tab:org162ecfd}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga959688}
\begin{table}[H]
\caption{\label{tab:org2df6b3f}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org784e442}
\begin{table}[H]
\caption{\label{tab:org1a2c538}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org03428e6}
\begin{table}[H]
\caption{\label{tab:org8ee5e8a}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3e26b20}
\begin{table}[H]
\caption{\label{tab:orgda54577}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1a34ba1}
\begin{table}[H]
\caption{\label{tab:orgfc26b8f}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6fc28bc}
\begin{table}[H]
\caption{\label{tab:org2d60eba}
...
\label{sec:org010799f}
\begin{table}[H]
\caption{\label{tab:orgd5a71c7}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orge529ed6}
\begin{table}[H]
\caption{\label{tab:orgb362fc6}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org30961c4}
\begin{table}[H]
\caption{\label{tab:orga8b165d}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1a56768}
\begin{table}[H]
\caption{\label{tab:org2f154b3}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgdc8f6df}
\begin{table}[H]
\caption{\label{tab:orgd2d4255}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org485d92f}
\begin{table}[H]
\caption{\label{tab:org2f3b673}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org609639b}
\begin{table}[H]
\caption{\label{tab:orgf2a3589}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf1ba1c1}
\begin{table}[H]
\caption{\label{tab:org15d347c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1526329}
\begin{table}[H]
\caption{\label{tab:orga923365}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org982ec9e}
\begin{table}[H]
\caption{\label{tab:orgb780c62}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org7ba9835}

\begin{center}
\captionof{table}{\label{tab:org1a720e0}
...
\caption{\label{fig:org093eea3}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:org895836f}

\begin{center}
\captionof{table}{\label{tab:org36cf7b0}
...
\caption{\label{fig:org33e0b5d}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{No measurement error and \(t_1=3000\)}
\label{sec:org529369a}

\begin{center}
\captionof{table}{\label{tab:orgab61e7d}
