...
\label{sec:org1c442a9}

\begin{table}[!htpb]
\caption{\label{tab:org55dbf5a}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:orgb63af99}

\begin{table}[H]
\caption{\label{tab:org46ae4fe}
...
\label{sec:org46a6c63}

\begin{table}[H]
\caption{\label{tab:orgb8a81d2}
...
\label{sec:org189da37}

\begin{table}[H]
\caption{\label{tab:org6ac385e}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6566f5c}
\begin{table}[H]
\caption{\label{tab:orgf740d24}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org357d656}
\begin{table}[H]
\caption{\label{tab:orgfb69ba9}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org0986192}

\begin{table}[H]
\caption{\label{tab:org053dabb}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd397d81}
\begin{table}[H]
\caption{\label{tab:org5a7dcc8}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org7e62415}
\begin{table}[H]
\caption{\label{tab:orgd409243}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3f3c149}
\begin{table}[H]
\caption{\label{tab:orgbeb5e99}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5dc997f}
\begin{table}[H]
\caption{\label{tab:org4a7f00c}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9d047f8}
\begin{table}[H]
\caption{\label{tab:orga938ceb}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5811312}
\begin{table}[H]
\caption{\label{tab:orgcc88aff}
...
\label{sec:org09082ff}
\begin{table}[H]
\caption{\label{tab:org52f0f60}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9ba6a95}
\begin{table}[H]
\caption{\label{tab:orgdfdec3c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org2672a09}
\begin{table}[H]
\caption{\label{tab:org28d2c0c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf9cb600}
\begin{table}[H]
\caption{\label{tab:orgf401a09}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9ea7d04}
\begin{table}[H]
\caption{\label{tab:org8f12be3}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orge9880da}
\begin{table}[H]
\caption{\label{tab:orgb0944fb}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org073fbff}
\begin{table}[H]
\caption{\label{tab:org8e811c5}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orge9a0072}
\begin{table}[H]
\caption{\label{tab:org6dcd60f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgdb8d0ed}
\begin{table}[H]
\caption{\label{tab:org5b1d8fc}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org687124b}
\begin{table}[H]
\caption{\label{tab:orgd1476f1}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org411e14b}

\begin{center}
\captionof{table}{\label{tab:org3aa97c6}
...
\hline
\(\rho _{f,Y}\) & -0.9360 & -0.8614 & -0.9091 & -0.9360\\
\(\rho _{p_s,Y}\) & -0.9257 & -0.8700 & -0.9060 & -0.9257\\
\hline
\end{tabular}
\end{center}
...
\caption{\label{fig:org4d9bf65}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:org3832f4a}

\begin{center}
\captionof{table}{\label{tab:org7ba6fd4}
Pearson correlation coefficient for decoherence time of \(t_1 = 1000\) and measurement error 0f 0.005}
\begin{tabular}{lrrrr}
 & \# of Gates & \# of SWAPs & Depth & \(V_Q\)\\
\hline
\(\rho _{f,Y}\) & -0.7637 & -0.6658 & -0.7354 & -0.7637\\
\(\rho _{p_s,Y}\) & -0.8341 & -0.7484 & -0.8076 & -0.8341\\
\hline
\end{tabular}
\end{center}
...
\caption{\label{fig:org657af53}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{No measurement error and \(t_1=3000\)}
\label{sec:org839113d}

\begin{center}
\captionof{table}{\label{tab:orgad86f4f}
Pearson correlation coefficient for decoherence time of \(t_1 = 3000\) and probability 0 for the measurement}
\begin{tabular}{lrrrr}
 & \# of Gates & \# of SWAPs & Depth & \(V_Q\)\\
\hline
\(\rho _{f,Y}\) & -0.9246 & -0.8482 & -0.9012 & -0.9246\\
\(\rho _{p_s,Y}\) & -0.9495 & -0.8972 & -0.9334 & -0.9495\\
\hline
\end{tabular}
\end{center}
