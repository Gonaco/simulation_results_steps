...
\section{First Step}
\label{sec:orgfd99ef1}

\begin{table}[htbp]
\caption{\label{tab:org688b7c2}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:orgd0af3c9}

\subsubsection{No initial placement}
\label{sec:org1984f54}
...
\label{sec:org239f5d7}

\begin{table}[htbp]
\caption{\label{tab:orgaa54aa5}
...
\label{sec:org67d8a55}

\begin{table}[htbp]
\caption{\label{tab:org00605a9}
