...
\section{First Step}
\label{sec:orgf2c1ce9}

\begin{table}[htbp]
\caption{\label{tab:org3ca7077}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:org3adba7e}

\subsubsection{No initial placement}
\label{sec:org9497aa4}
...
\label{sec:org423f5fb}

\begin{table}[htbp]
\caption{\label{tab:org1973f39}
