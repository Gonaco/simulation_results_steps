...
\label{sec:org27e10b3}

\begin{table}[!htpb]
\caption{\label{tab:org58e5cd2}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org03dd8e1}

\begin{table}[H]
\caption{\label{tab:orgdb5cff6}
...
\label{sec:orgffe17ec}

\begin{table}[H]
\caption{\label{tab:org14ac66d}
...
\label{sec:org08f0912}

\begin{table}[H]
\caption{\label{tab:org63bd4d8}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga659689}
\begin{table}[H]
\caption{\label{tab:orge4a62e8}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8cfb6c6}
\begin{table}[H]
\caption{\label{tab:org933a4d1}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org03458d9}

\begin{table}[H]
\caption{\label{tab:orgb968d09}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8a664dc}
\begin{table}[H]
\caption{\label{tab:orge765fde}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org99ca754}
\begin{table}[H]
\caption{\label{tab:org2e95a35}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org57d6a18}
\begin{table}[H]
\caption{\label{tab:orgd909956}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga43500e}
\begin{table}[H]
\caption{\label{tab:org04cca21}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org67ed068}
\begin{table}[H]
\caption{\label{tab:orgc192dd1}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org576c048}
\begin{table}[H]
\caption{\label{tab:orgc592cd1}
...
\label{sec:orgb8bbea3}
\begin{table}[H]
\caption{\label{tab:org680ab36}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org66d17dd}
\begin{table}[H]
\caption{\label{tab:org0013b9d}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgc8bfd1d}
\begin{table}[H]
\caption{\label{tab:org666e283}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org18506ea}
\begin{table}[H]
\caption{\label{tab:orgd7fe32f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org606621e}
\begin{table}[H]
\caption{\label{tab:orgbb6db13}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org55f4b99}
\begin{table}[H]
\caption{\label{tab:org1cd58f9}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org23ab89f}
\begin{table}[H]
\caption{\label{tab:orgbcc6246}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8ce20ba}
\begin{table}[H]
\caption{\label{tab:orgb3e2e00}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org28d853e}
\begin{table}[H]
\caption{\label{tab:orgcbc7cd6}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgcd05b94}
\begin{table}[H]
\caption{\label{tab:org24634fc}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org03e4bb5}

\begin{center}
\captionof{table}{\label{tab:orgd3cd474}
...
\subsection{\(t_1=1000\)}
\label{sec:org7a1d793}

\begin{center}
\captionof{table}{\label{tab:orgcf848c4}
...
\label{sec:org33d5045}

\begin{center}
\captionof{table}{\label{tab:org10f3857}
