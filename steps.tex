...
\label{sec:org8bb4ee9}

\begin{table}[!htpb]
\caption{\label{tab:org3b67b3a}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org6617d0a}

\begin{table}[H]
\caption{\label{tab:orgedc00db}
...
\label{sec:orgc005ca0}

\begin{table}[H]
\caption{\label{tab:org9c2453f}
...
\label{sec:org338d29c}

\begin{table}[H]
\caption{\label{tab:org716240b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgfde7161}
\begin{table}[H]
\caption{\label{tab:org9301ff4}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6dccf9c}
\begin{table}[H]
\caption{\label{tab:orgf5e10c1}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6f52158}

\begin{table}[H]
\caption{\label{tab:orga8c4768}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org77fd167}
\begin{table}[H]
\caption{\label{tab:org36be244}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org99bfac2}
\begin{table}[H]
\caption{\label{tab:org313260b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org03c280b}
\begin{table}[H]
\caption{\label{tab:org2b3d528}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3a56602}
\begin{table}[H]
\caption{\label{tab:orgefaf528}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org855ed7b}
\begin{table}[H]
\caption{\label{tab:org70b142b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgdcfe11a}
\begin{table}[H]
\caption{\label{tab:org7d99e64}
...
\label{sec:org48c5a15}
\begin{table}[H]
\caption{\label{tab:org3966f01}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7e963b5}
\begin{table}[H]
\caption{\label{tab:orgf96b985}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgb4dccdb}
\begin{table}[H]
\caption{\label{tab:org630c561}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf09d351}
\begin{table}[H]
\caption{\label{tab:orgab85891}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9888aef}
\begin{table}[H]
\caption{\label{tab:org09a069d}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc5b7517}
\begin{table}[H]
\caption{\label{tab:orgd5af785}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgc712a16}
\begin{table}[H]
\caption{\label{tab:orgd619b69}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8b7b4dd}
\begin{table}[H]
\caption{\label{tab:orge7ac7e1}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga3c1113}
\begin{table}[H]
\caption{\label{tab:org64d414a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9e26ee3}
\begin{table}[H]
\caption{\label{tab:org0e2c641}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org1698b7c}

\begin{center}
\captionof{table}{\label{tab:org25de234}
...
\caption{\label{fig:org0ff31f5}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:org000b962}

\begin{center}
\captionof{table}{\label{tab:orgcff24e7}
...
\caption{\label{fig:org0a805eb}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{No measurement error and \(t_1=3000\)}
\label{sec:org3555c69}

\begin{center}
\captionof{table}{\label{tab:org64f1b9e}
