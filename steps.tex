...
\section{First Step}
\label{sec:orgff2903a}

\begin{table}[htbp]
\caption{\label{tab:orgebe0243}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\begin{table}[htbp]
\caption{\label{tab:org6c48c61}
Other mapper statistics}
\centering
\begin{tabular}{llrrrrrr}
\hline
Mapper & Init. place & \# used qubits & depth & \# gates & \# SWAPS & \# meet. in between & Parallelism\\
\hline
No & No & 5 & 78 & 84 & 0 & 0 & 0.071428571\\
\hline
minextendrc & No & 7 & 226 & 237 & 17 & 3 & 0.046413502\\
minextendrc & Yes & 6 & 173 & 174 & 10 & 2 & 5.7471264\,(-3)\\
minextend & No & 8 & 158 & 228 & 16 & 1 & 0.30701754\\
minextend & Yes & 6 & 139 & 165 & 9 & 0 & 0.15757576\\
base & No & 6 & 177 & 228 & 16 &  & 0.22368421\\
base & Yes & 6 & 130 & 147 & 7 &  & 0.11564626\\
\hline
\end{tabular}
\end{table}
...
\label{sec:orgb0a229d}

\subsubsection{No initial placement}
\label{sec:orge88f3da}
...
\label{sec:org70991f1}

\begin{table}[htbp]
\caption{\label{tab:org4e99413}
...
\label{sec:org994fb12}

\begin{table}[htbp]
\caption{\label{tab:orgf286e64}
