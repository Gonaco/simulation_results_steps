...
\label{sec:orgdad8066}

\begin{table}[!htpb]
\caption{\label{tab:orgded1e00}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org5a25159}

\begin{table}[H]
\caption{\label{tab:orge9c340b}
...
\label{sec:orgf1790e3}

\begin{table}[H]
\caption{\label{tab:org51e0a6f}
...
\label{sec:org5fccb10}

\begin{table}[H]
\caption{\label{tab:org9056ba9}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6d170d2}
\begin{table}[H]
\caption{\label{tab:orga2f9431}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2d13f88}
\begin{table}[H]
\caption{\label{tab:org95f91ea}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6275d9f}

\begin{table}[H]
\caption{\label{tab:orgbaa4a70}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgde48f56}
\begin{table}[H]
\caption{\label{tab:org59b4484}
Results after 1000 iterations}
\centering
\small
...
\label{sec:orgbaedb5c}
\begin{table}[H]
\caption{\label{tab:org64b1f2d}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org38d5405}
\begin{table}[H]
\caption{\label{tab:org287169c}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1716f16}
\begin{table}[H]
\caption{\label{tab:orge402746}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org88e87ba}
\begin{table}[H]
\caption{\label{tab:orge7dce36}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgad71e28}
\begin{table}[H]
\caption{\label{tab:org713fac8}
...
\label{sec:org2fa38b6}
\begin{table}[H]
\caption{\label{tab:org3184ff6}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org0c40535}
\begin{table}[H]
\caption{\label{tab:org03f153a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org0d43663}
\begin{table}[H]
\caption{\label{tab:org6372119}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd9b593b}
\begin{table}[H]
\caption{\label{tab:orgc39d951}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org29b59e3}
\begin{table}[H]
\caption{\label{tab:org6e9d894}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org28b1f73}
\begin{table}[H]
\caption{\label{tab:orgeb85da9}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org96855bf}
\begin{table}[H]
\caption{\label{tab:org131cf6e}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5654687}
\begin{table}[H]
\caption{\label{tab:org16cd21f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org7539670}
\begin{table}[H]
\caption{\label{tab:orga6e4b38}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6f29cb0}
\begin{table}[H]
\caption{\label{tab:org16ede13}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:orgc15dd9f}

\begin{center}
\captionof{table}{\label{tab:orge82a2a6}
...
\subsection{\(t_1=1000\)}
\label{sec:orgd355ff4}

\begin{center}
\captionof{table}{\label{tab:org383d9a3}
...
\label{sec:org46837c1}

\begin{center}
\captionof{table}{\label{tab:org2a447bb}
