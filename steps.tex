...
\label{sec:org42067d6}

\begin{table}[!htpb]
\caption{\label{tab:orga9d3d02}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org630513c}

\begin{table}[H]
\caption{\label{tab:orgd3045a8}
...
\label{sec:org9db6240}

\begin{table}[H]
\caption{\label{tab:org6e39a34}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd81dd2a}
\begin{table}[H]
\caption{\label{tab:orgbc579fe}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgaabe27f}
\begin{table}[H]
\caption{\label{tab:org8738b97}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3b8a67b}

\begin{table}[H]
\caption{\label{tab:org3091053}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orge0d60e2}
\begin{table}[H]
\caption{\label{tab:org629e0f7}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org0c419bd}
\begin{table}[H]
\caption{\label{tab:orge9a9330}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgadb9a03}
\begin{table}[H]
\caption{\label{tab:org19a72a7}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3898a46}
\begin{table}[H]
\caption{\label{tab:orgec0d32b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org669e2c8}
\begin{table}[H]
\caption{\label{tab:orgd6f35b7}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org660f291}
\begin{table}[H]
\caption{\label{tab:orgf937f34}
...
\label{sec:orgaf606a3}
\begin{table}[H]
\caption{\label{tab:orgb320d23}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org148e88a}
\begin{table}[H]
\caption{\label{tab:org3351e40}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org81436d3}
\begin{table}[H]
\caption{\label{tab:orge57d54a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgb589355}
\begin{table}[H]
\caption{\label{tab:orgcdd3339}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org4f51714}
\begin{table}[H]
\caption{\label{tab:org6a0cf5c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org7e526f5}
\begin{table}[H]
\caption{\label{tab:org2567439}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgacc80b5}
\begin{table}[H]
\caption{\label{tab:org56b5ffc}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1320995}
\begin{table}[H]
\caption{\label{tab:org875d532}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9f31b3b}
\begin{table}[H]
\caption{\label{tab:org7939b4b}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:orgb2adfdb}

\begin{center}
\captionof{table}{\label{tab:org4101096}
...
\caption{\label{fig:orgdd83fb4}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:orgb8ee216}

\begin{center}
\captionof{table}{\label{tab:orge4888d1}
...
\caption{\label{fig:orgec3749d}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{No measurement error and \(t_1=3000\)}
\label{sec:org3bca3b9}

\begin{center}
\captionof{table}{\label{tab:orgbf875ca}
