...
\label{sec:org8e3e5ce}

\begin{table}[!htpb]
\caption{\label{tab:orgabf4f4a}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org708ff44}

\begin{table}[H]
\caption{\label{tab:org6d409c9}
...
\label{sec:org2739b53}

\begin{table}[H]
\caption{\label{tab:org5f6259a}
...
\label{sec:orgb16e98c}

\begin{table}[H]
\caption{\label{tab:orgb1d3892}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgf40f08c}
\begin{table}[H]
\caption{\label{tab:org6c7eecf}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org742efc9}
\begin{table}[H]
\caption{\label{tab:org7019a03}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org07d266f}

\begin{table}[H]
\caption{\label{tab:org109d7a7}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org89127ae}
\begin{table}[H]
\caption{\label{tab:org53cda42}
Results after 1000 iterations}
\centering
\small
...
\label{sec:orgeff91e0}
\begin{table}[H]
\caption{\label{tab:org78cc0a1}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2b6d5e8}
\begin{table}[H]
\caption{\label{tab:org9f681f3}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd8f9762}
\begin{table}[H]
\caption{\label{tab:org9c696c1}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org23bfc7f}
\begin{table}[H]
\caption{\label{tab:org9295d4a}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orge2bae5d}
\begin{table}[H]
\caption{\label{tab:org8b1719d}
...
\label{sec:orgae6433a}
\begin{table}[H]
\caption{\label{tab:org50d5d80}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org4db4d6d}
\begin{table}[H]
\caption{\label{tab:orge632b9a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org517eaf5}
\begin{table}[H]
\caption{\label{tab:org7fd9314}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org50f2df2}
\begin{table}[H]
\caption{\label{tab:orgcfecc9a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8f9ccad}
\begin{table}[H]
\caption{\label{tab:org56a00d4}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org31e4495}
\begin{table}[H]
\caption{\label{tab:org1667e39}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org5783328}
\begin{table}[H]
\caption{\label{tab:org6f35b62}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd33a5d9}
\begin{table}[H]
\caption{\label{tab:org59319ed}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgdd3e624}
\begin{table}[H]
\caption{\label{tab:org0244d26}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orge6a2f08}
\begin{table}[H]
\caption{\label{tab:org6a14cfe}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:orgb4c8936}

\begin{center}
\captionof{table}{\label{tab:orgde6f062}
...
\begin{figure}
\centering
\begin{subfigure}[b]{0.5\linewigth}
\centering
\includegraphics[width=0.75\linewidth]{f_2qg_3000_0_005.png}
...
\begin{subfigure}[b]{0.5\linewigth}
\centering
\includegraphics[width=0.75\linewidth]{ps_2qg_3000_0_005.png}
\caption{Number of two-qubit gates against fidelity}
...
\subsection{\(t_1=1000\)}
\label{sec:orgce07679}

\begin{center}
\captionof{table}{\label{tab:org0d3c0b2}
...
\begin{subfigure}[b]{0.5\linewigth}
\centering
\includegraphics[width=0.75\linewidth]{f_2qg_1000_0_005.png}
\caption{Number of two-qubit gates against fidelity}
\label{fig:f_2qg_3000_0_005}
    \vspace{4ex}
\end{subfigure}
...
\begin{subfigure}[b]{0.5\linewigth}
\centering
\includegraphics[width=0.75\linewidth]{ps_2qg_1000_0_005.png}
\caption{Number of two-qubit gates against fidelity}
\label{fig:ps_2qg_3000_0_005}
\end{subfigure}
...
\label{sec:orgac74982}

\begin{center}
\captionof{table}{\label{tab:org9996dfa}
...
\begin{figure}
  \begin{subfigure}[b]{0.5\linewidth}
    \centering
    \includegraphics[width=0.75\linewidth]{f_2qg_3000_0.png}
    \caption{Number of two-qubit gates against fidelity} 
...
\begin{subfigure}[b]{0.5\linewigth}
\centering
\includegraphics[width=0.75\linewidth]{ps_2qg_3000_0.png}
\caption{Number of two-qubit gates against fidelity}
