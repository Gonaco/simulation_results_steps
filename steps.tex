...
\section{First Step}
\label{sec:org327dee3}

\begin{table}[htbp]
\caption{\label{tab:orgb211fd1}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:org9870ac0}

\subsubsection{No initial placement}
\label{sec:org7f1a62a}
...
\label{sec:orgf2ed333}

\begin{table}[htbp]
\caption{\label{tab:orga207da9}
...
\label{sec:org4a91d46}

\begin{table}[htbp]
\caption{\label{tab:orgd1a6eb8}
...
\label{sec:org5be5f34}


\subsubsection{Probability of success}
\label{sec:org93f01e6}

\begin{table}[htbp]
\caption{\label{tab:org5bf8859}
