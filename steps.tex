...
\section{First Step}
\label{sec:org6bffe80}

\begin{table}[htbp]
\caption{\label{tab:orgb8eb756}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:org54cf6bd}

\begin{minipage}[t]{.45\textwidth}

\begin{enumerate}
\item With Resource constraints
\label{sec:orgc7493cc}
...
\label{sec:orgce577d6}
\section{Simplest benchmarks results}
\label{sec:org7f1ebfd}
\end{document}
