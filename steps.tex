...
\label{sec:org11af211}

\begin{table}[!htpb]
\caption{\label{tab:orgbf70550}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:orgc696f5b}

\begin{table}[H]
\caption{\label{tab:orge395468}
...
\label{sec:org81ed936}

\begin{table}[H]
\caption{\label{tab:org1e84bd3}
...
\label{sec:orgae5126e}

\begin{table}[H]
\caption{\label{tab:orga2d12ca}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2042432}
\begin{table}[H]
\caption{\label{tab:org0feccdf}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org70d6b27}
\begin{table}[H]
\caption{\label{tab:orgd1ef503}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org52c0914}

\begin{table}[H]
\caption{\label{tab:org2642a41}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1cc7bdf}
\begin{table}[H]
\caption{\label{tab:org1ed224b}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org10e0a72}
\begin{table}[H]
\caption{\label{tab:orgfeab914}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org52d421d}
\begin{table}[H]
\caption{\label{tab:org604f649}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgfe4dcf8}
\begin{table}[H]
\caption{\label{tab:org9df2e2e}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org91cff08}
\begin{table}[H]
\caption{\label{tab:org7d077df}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org01e4030}
\begin{table}[H]
\caption{\label{tab:org2a05011}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org710382a}
\begin{table}[H]
\caption{\label{tab:org57db941}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org2f13e25}
\begin{table}[H]
\caption{\label{tab:org6089271}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org78b5928}
\begin{table}[H]
\caption{\label{tab:orgc42a7ca}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org58de328}
\begin{table}[H]
\caption{\label{tab:org0d95680}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5b14e59}
\begin{table}[H]
\caption{\label{tab:orge672410}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org0a0fdd5}
\begin{table}[H]
\caption{\label{tab:org65afafd}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org39cb33f}
\begin{table}[H]
\caption{\label{tab:org2f12a7d}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgac38cf4}
\begin{table}[H]
\caption{\label{tab:org842dc69}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc6099a5}
\begin{table}[H]
\caption{\label{tab:orgd24adf9}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org8094465}

\begin{center}
\captionof{table}{\label{tab:org1636b95}
...
\caption{\label{fig:orgee4bb48}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:orgc8ac7e6}

\begin{center}
\captionof{table}{\label{tab:org078fe65}
...
\caption{\label{fig:orgc695b98}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{No measurement error and \(t_1=3000\)}
\label{sec:orgcfa4822}

\begin{center}
\captionof{table}{\label{tab:orgd45c59c}
