...
\label{sec:org91414de}

\begin{table}[!htpb]
\caption{\label{tab:org9964e4c}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:orgc3b9c15}

\begin{table}[H]
\caption{\label{tab:org08744d0}
...
\label{sec:orge5ae848}

\begin{table}[H]
\caption{\label{tab:orgce31302}
...
\label{sec:orga067889}

\begin{table}[H]
\caption{\label{tab:orga7a1486}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd1b85ec}
\begin{table}[H]
\caption{\label{tab:orgb22eaa7}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgda07f6f}
\begin{table}[H]
\caption{\label{tab:orgf9e1fc1}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org20b0a79}

\begin{table}[H]
\caption{\label{tab:org64b0786}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5dae383}
\begin{table}[H]
\caption{\label{tab:orgbfc059e}
Results after 1000 iterations}
\centering
\small
...
\label{sec:orgdeb74b4}
\begin{table}[H]
\caption{\label{tab:org537e37d}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3102686}
\begin{table}[H]
\caption{\label{tab:org1a1c1fe}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc277db4}
\begin{table}[H]
\caption{\label{tab:org21e9161}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9e281dc}
\begin{table}[H]
\caption{\label{tab:orgc1fd48b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org9de10bd}
\begin{table}[H]
\caption{\label{tab:orgbfd602c}
...
\label{sec:org00064d2}
\begin{table}[H]
\caption{\label{tab:org8ad7f6a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc07bd8d}
\begin{table}[H]
\caption{\label{tab:org51f243d}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgf64f941}
\begin{table}[H]
\caption{\label{tab:org9183cdf}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org96c7663}
\begin{table}[H]
\caption{\label{tab:org1a19239}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org134af15}
\begin{table}[H]
\caption{\label{tab:orge2cf3dd}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org24df63f}
\begin{table}[H]
\caption{\label{tab:org1c792b0}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org9f65d44}
\begin{table}[H]
\caption{\label{tab:orgefb385a}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8ba50f8}
\begin{table}[H]
\caption{\label{tab:org55385c5}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3e9a0f0}
\begin{table}[H]
\caption{\label{tab:org348e925}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org03a4c87}
\begin{table}[H]
\caption{\label{tab:orgf012958}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\caption{\label{fig:org02294d2}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{No measurement error and \(t_1=3000\)}
\label{sec:orgac03276}

\begin{center}
\captionof{table}{\label{tab:org80dcb2e}
