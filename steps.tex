...
\section{First Step}
\label{sec:org4dcec99}

\begin{table}[!htpb]
\caption{\label{tab:org2b6f1a5}
Benchmark used}
\centering
\begin{tabular}{lrrr}
\hline
...
\label{sec:org6f4cb78}

\subsubsection{No initial placement}
\label{sec:orgc39d4d5}
...
\label{sec:orgbc34f3a}

\begin{table}[H]
\caption{\label{tab:org1a68c5c}
...
\label{sec:orgfc06404}

\begin{table}[H]
\caption{\label{tab:org4be0b94}
...
\label{sec:orgc6fc734}


\subsubsection{Probability of success}
\label{sec:orgf31d91f}

\begin{table}[H]
\caption{\label{tab:orge4d0bf4}
...
\label{sec:orga783ace}

\begin{table}[!htpb]
\caption{\label{tab:orgf1de4af}
...
\label{sec:org9d587d0}

\begin{table}[!htpb]
\caption{\label{tab:org3b67a54}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org846b11f}

\begin{table}[!htpb]
\caption{\label{tab:orga468780}
...
\label{sec:org6b90f57}

\begin{table}[!htpb]
\caption{\label{tab:org2976541}
Results after 1000 iterations}
\centering
\begin{tabular}{llrrrrrr}
\hline
...
\label{sec:orgdba51ab}
\begin{table}[!htpb]
\caption{\label{tab:org3da3a06}
Results after 1000 iterations}
\centering
\begin{tabular}{llrrrrrr}
\hline
...
\label{sec:orgec42bc5}
\begin{table}[!htpb]
\caption{\label{tab:orga537286}
Results after 1000 iterations}
\centering
\begin{tabular}{llrrrrrr}
\hline
...
\label{sec:org6eebdf3}
\begin{table}[!htpb]
\caption{\label{tab:org484ff85}
Results after 1000 iterations}
\centering
...
\label{sec:orgbec687a}
\begin{table}[!htpb]
\caption{\label{tab:org715d938}
Results after 1000 iterations}
\centering
\begin{tabular}{llllllll}
\hline
...
\label{sec:org8d819a0}
\begin{table}[!htpb]
\caption{\label{tab:orgd115c6f}
Results after 1000 iterations}
\centering
\begin{tabular}{llllllll}
\hline
