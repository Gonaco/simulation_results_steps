...
\label{sec:org296d61c}

\begin{table}[!htpb]
\caption{\label{tab:orgb713143}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org820d648}

\begin{table}[H]
\caption{\label{tab:orgafb9b63}
...
\label{sec:org4c3edf0}

\begin{table}[H]
\caption{\label{tab:org1507077}
...
\label{sec:orgba21cab}

\begin{table}[H]
\caption{\label{tab:orga65ce28}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgdc8d248}
\begin{table}[H]
\caption{\label{tab:org6361334}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org261cf0a}
\begin{table}[H]
\caption{\label{tab:org1a7c5a6}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org52c6130}

\begin{table}[H]
\caption{\label{tab:org657cce6}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org3a43aee}
\begin{table}[H]
\caption{\label{tab:org328061a}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org3a65be9}
\begin{table}[H]
\caption{\label{tab:org981fefe}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5bfd494}
\begin{table}[H]
\caption{\label{tab:orgbe6ffb2}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org2f886aa}
\begin{table}[H]
\caption{\label{tab:orgdc9c13b}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd4959f7}
\begin{table}[H]
\caption{\label{tab:org13078a9}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd775980}
\begin{table}[H]
\caption{\label{tab:org33106f7}
...
\label{sec:org53dd88b}
\begin{table}[H]
\caption{\label{tab:org501eb70}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5d31b98}
\begin{table}[H]
\caption{\label{tab:org55f6963}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgb58130e}
\begin{table}[H]
\caption{\label{tab:orga1e5490}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org8f92566}
\begin{table}[H]
\caption{\label{tab:org73462db}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgdbff2ad}
\begin{table}[H]
\caption{\label{tab:org1cae6ef}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org26aa1a4}
\begin{table}[H]
\caption{\label{tab:org73f537f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgcd58009}
\begin{table}[H]
\caption{\label{tab:org9608b7c}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org20054e4}
\begin{table}[H]
\caption{\label{tab:org75cb1db}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org918c15d}
\begin{table}[H]
\caption{\label{tab:orgf5b5d26}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\begin{center}
\captionof{table}{\label{tab:org959d121}
...
\begin{center}
\captionof{table}{\label{tab:org93d1366}
