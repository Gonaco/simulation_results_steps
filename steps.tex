...
\label{sec:orgd7b2100}

\begin{table}[!htpb]
\caption{\label{tab:orgb5966e6}
Benchmarks used}
\centering
\begin{tabular}{lrr}
\hline
...
\label{sec:org45a37f5}

\begin{table}[H]
\caption{\label{tab:org416b7fe}
...
\label{sec:org0d2bf82}

\begin{table}[H]
\caption{\label{tab:orgd5d5ce0}
...
\label{sec:orgf417d42}

\begin{table}[H]
\caption{\label{tab:orgc644932}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgc5b97bb}
\begin{table}[H]
\caption{\label{tab:orgac43134}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org17eedb3}
\begin{table}[H]
\caption{\label{tab:orgd57a34a}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org90c900d}

\begin{table}[H]
\caption{\label{tab:orga624259}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orga056cf4}
\begin{table}[H]
\caption{\label{tab:orgf1516a2}
Results after 1000 iterations}
\centering
\small
...
\label{sec:org2c07d89}
\begin{table}[H]
\caption{\label{tab:orgcb06126}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6dc1389}
\begin{table}[H]
\caption{\label{tab:org845984e}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6206d59}
\begin{table}[H]
\caption{\label{tab:org753b382}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1f900b7}
\begin{table}[H]
\caption{\label{tab:org3f12554}
Results after 1000 iterations}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5f24d6b}
\begin{table}[H]
\caption{\label{tab:org2bc5bf8}
...
\label{sec:orgc2a86b1}
\begin{table}[H]
\caption{\label{tab:org965749f}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org37a064e}
\begin{table}[H]
\caption{\label{tab:orgda4b9c0}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:orgaacddfa}
\begin{table}[H]
\caption{\label{tab:org7b6c7c9}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org1a3bc8a}
\begin{table}[H]
\caption{\label{tab:org5a94cd8}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org6b4abe4}
\begin{table}[H]
\caption{\label{tab:org48552ac}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgd3e0280}
\begin{table}[H]
\caption{\label{tab:org6881b55}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrllrrrr}
...
\label{sec:org95331e5}
\begin{table}[H]
\caption{\label{tab:orgc06ef81}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgafcfd24}
\begin{table}[H]
\caption{\label{tab:org59a8f47}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:org5a40123}
\begin{table}[H]
\caption{\label{tab:org4d6c0cd}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\label{sec:orgcd783e5}
\begin{table}[H]
\caption{\label{tab:orgf25e0fa}
Results after 1000 iterations, \(t_1 = t_2 = 3000\)}
\centering
\small
\begin{tabular}{lrrrrrrr}
...
\subsection{\(t_1=3000\)}
\label{sec:org1b3df6d}

\begin{center}
\captionof{table}{\label{tab:org668a674}
...
\caption{\label{fig:org9217f67}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{\(t_1=1000\)}
\label{sec:orge5c38ca}

\begin{center}
\captionof{table}{\label{tab:org64b3dc6}
...
\caption{\label{fig:orga810906}
Number of swaps and fidelity difference relationship's}
\end{figure}

\subsection{No measurement error and \(t_1=3000\)}
\label{sec:org6c63fa7}

\begin{center}
\captionof{table}{\label{tab:orgac577b7}
